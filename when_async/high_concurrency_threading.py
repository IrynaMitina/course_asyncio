""" benchmark for using threads in case of high concurrency.
...
print(f"[threading] memory usage: {memory_usage:.2f} MB")
print(f"[threading] context switches: {context_switches}")